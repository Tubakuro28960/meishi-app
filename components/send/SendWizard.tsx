...
const s: Record<string, React.CSSProperties> = {
  ...
  stepper: { display: "flex", alignItems: "center", marginBottom: "1.5rem", overflowX: "auto" },
  stepItem: { display: "flex", alignItems: "center", gap: "0.375rem", flex: "0 0 auto" },
  stepCircle: { width: 26, height: 26, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.8125rem", fontWeight: 700, flexShrink: 0 },
  stepActive: { background: "#2563eb", color: "#fff" },
  stepDone: { background: "#16a34a", color: "#fff" },
  stepIdle: { background: "#e2e8f0", color: "#94a3b8" },
  stepLabel: { fontSize: "0.75rem", color: "#94a3b8", whiteSpace: "nowrap" },
  stepLabelActive: { color: "#1e293b", fontWeight: 600 },
  stepLine: { width: 20, height: 1, background: "#e2e8f0", flexShrink: 0, margin: "0 0.25rem" },
  ...
  tmplSubject: { fontSize: "0.8125rem", color: "#64748b", wordBreak: "break-all" },
  previewList: { display: "flex", flexDirection: "column", gap: "1rem" },
  previewCard: { border: "1px solid #e2e8f0", borderRadius: 6, overflow: "hidden" },
  previewHeader: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", padding: "0.75rem 1rem", background: "#f8fafc", borderBottom: "1px solid #e2e8f0", flexWrap: "wrap", gap: "0.75rem" },
